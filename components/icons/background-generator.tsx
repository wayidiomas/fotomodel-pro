...
export interface BackgroundGeneratorProps extends React.SVGProps<SVGSVGElement> {}

export const BackgroundGenerator: React.FC<BackgroundGeneratorProps> = (props) => {
  return (
    <svg
      width="24"
      height="24"
